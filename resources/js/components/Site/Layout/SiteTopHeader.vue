                ...
                <div class="row">
                    <div class="col-md-6  col-lg-6 offset-md-3 offset-lg-3">
                        <ul class="top-heading">
                            ...
                            <li><a href="#"><i class="fas fa-check"></i> <span>Nem og gennemskuelig handel</span></a>
                            </li>
                            <li><a href="#"><i class="fas fa-check"></i> <span>Sikker betaling</span></a></li>
                            <li><a href="#"><i class="fas fa-check"></i>
                                <span>Køberbeskyttelse på op til 10.000 kr</span></a></li>
                        </ul>
                    </div>
                </div>
            </div>
