        ...
        <div class="col-md-9 col-lg-10" style="background: #fff">
          <div class="main-content">
            <div class="row">
              ...
              <router-link
                tag="div"
                to="/customer/orders?type=running"
              ...
              <router-link
                tag="div"
                to="/customer/canceled/orders?type=canceled"
                class="col-md-3 col-lg-3 wow bounceIn cp"
              >
                <div class="shadow border-bottom border-red">
                  <div class="card-body text-center">
                    <h2 class="text-muted">
                      <strong>{{ dashboardData.canceledOrders }}</strong>
                    </h2>
                    <p class="text-muted">
                      <strong>Annullerede ordrer</strong>
                    </p>
                  </div>
                </div>
              </router-link>
              ...
              >
                <div class="shadow border-bottom border-pink">
                  <div class="card-body text-center">
                    <h2 class="text-muted">
                      <strong>{{ dashboardData.totalFavourites }}</strong>
                    </h2>
              ...
              >
                <div class="shadow border-bottom border-pink">
                  <div class="card-body text-center">
                    <h2 class="text-muted">
                      <strong>{{ dashboardData.totalReminders }}</strong>
                    </h2>
...
export default {
  ...
  methods: {
    getAdminDashboardData() {
      axios
        .get(`/api/customer/dashboard/data`)
        .then((res) => {
