  ...
  <div class="page-wrapper wow" id="product_area">
              ...
              <div class="package-products">
                ...
                <div class="row">
                  ...
                  >
                    ...
                    >
                      <slide
                        v-for="product in requestProducts"
                        :key="product.id"
                      >
    ...
    <div
      ...
      style="
        ...
        bottom: 0;
        z-index: 1;
        background: rgba(222, 222, 211, 0.9);
      "
    >
      <img width="32px" src="/images/icons/cookie.png" alt="cookies icon" />
      <span
        >For at give dig den bedste oplevelse hos DanPanel anvender vi cookies.
        Ved at anvende DanPanels platform og klikke rundt på vores site
