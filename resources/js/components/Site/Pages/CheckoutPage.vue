<template>
  <div class="page-wrapper">
    <div class="container">
      ...
      <div v-if="!isLoading">
        <div
          class="product-info-area mt-4 shadow-sm p-4"
            ...
            <div class="ml-auto col-12 col-lg-4" v-if="!hideOrderDetailsForm">
              ...
              <div class="checkout-customer-info">
                <div class="cards shadow">
                  ...
                  <div class="card-body">
                    <table
                      class="checkout-table table table-hover"
                      style="width: 100%"
                    >
                      <tr
                        v-for="variation in product.product_variation"
                        :key="variation.id"
                      >
                        <!--                                                <td></td>-->
                      ...
                      <tr>
                        ...
                        <td>
                          {{ product.join_price.toFixed(2) }} Kr ({{
                            product.join_payment_percentage
                          }}
                          % of {{ product.offer_price }} Kr)
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td colspan="2">
                          <div>
                            <label class="checkbox_container"
                              ...
                              <input
                                v-model="orderDetails.newsletter"
                                value="1"
                                type="checkbox" />
  ...
  methods: {
    changeProductPriceOnVariationChange(variationID, optionID, price) {
      let selectedIndex = this.selectedVariations.findIndex(
        (x) => x.variationID === parseInt(variationID)
      );
      ...
      if (selectedIndex !== -1) {
        ...
        let optionVariationOptionId =
          this.selectedVariations[selectedIndex].optionID;
        ...
        let newPrice =
          (this.product.join_payment_percentage / 100) *
          optionVariationOption.price;
    ...
    increaseOrderQuantity() {
      if (this.product.max_unit_per_user > this.orderDetails.quantity) {
        ...
        alert("Minimum ordremængde er " + this.product.max_unit_per_user);
      }
    },
    decreaseOrderQuantity() {
      if (this.orderDetails.quantity > 1) {
        ...
        alert("Minimum ordremængde er 1");
      }
    },
    getProduct(slug) {
      axios
          ...
          if (seletedVariationCokkieObject) {
            ...
            this.selectedVariations.forEach(function (variation) {
              let selectedVariationIndex =
                vm.product.product_variation.findIndex(
              ...
              vm.product.join_price +=
                (vm.product.join_payment_percentage / 100) * needToAddPrice;
              vm.orderDetails.totalPrice +=
                (vm.product.join_payment_percentage / 100) * needToAddPrice;
    ...
    createOrder() {
      ...
      if (totalVariationsOfProduct > 0) {
        if (totalVariationsOfProduct !== this.selectedVariations.length) {
          Alert.showErrorAlert("Vælg produktvarianter");
          return;
        }
      }
