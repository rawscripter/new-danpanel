    ...
    <div class="row">
      ...
      <div class="col-md-9 m-auto" v-if="!isLoading">
        <div class="blog-area shadow">
          <div
            class="blog-read-title customize-sub-category-header p-3"
            style="
              color: white;
              font-size: 20px;
              background-color: rgb(0 172 242);
            "
          >
            {{ blog.title }}
          </div>
          <div class="row border ml-0 mr-0">
            <div class="col-md-12 col-lg-12">
              <div class="blog-read-img-comment">
                <div class="blog-read-img border mt-3">
                  <img
              ...
              <div class="blog-read-content-area border1 p-3">
                ...
                <div class="date_authore mt-3">
                  <p>Skrevet af Anja in {{ blog.created_at }}</p>
                </div>
              </div>
            </div>
          </div>
...
export default {
  ...
  methods: {
    getBlogDetails() {
      axios.get(`${APP_URL}/api/blog/${this.blogSlug}`).then((res) => {
        if (res.data.success) {
