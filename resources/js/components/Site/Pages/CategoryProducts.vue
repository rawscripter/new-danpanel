        ...
        <div class="container">
            <div class="row">
                <div class="col-md-2 col-lg-3">
                    <ProductFilter
                        @filterFromResetCompleted="filterFromResetCompleted"
                        :callResetFilterFunction="resetFilter"
                        @filterProduct="eventHandler"
                    ></ProductFilter>
                </div>
                        ...
                        <div class="product-area" v-if="totalProducts">
                            <div class="row">
                                <div
                                    ...
                                    :key="product.id"
                                    class="wow bounceIn  shadow-sm ml-0 pl-0 mr-0 pr-0"
                                    :class=" product.is_package_product ? 'col-12 pl-5 pr-5 pt-2 pb-2 mb-3' : 'col-6 col-md-4 col-lg-4 col-sm-6'"
                                >
                                    <!-- product single  -->
                                    <SinglePackageProduct :product="product"
                                                          v-if="product.is_package_product"></SinglePackageProduct>
                                    <SingleProduct :product="product" v-else></SingleProduct>
...
import SinglePackageProduct from "../Layout/Product/Loop/SinglePackageProduct";
    ...
    methods: {
        ...
        loadMore() {
            ...
            setTimeout((e) => {
                ...
                axios
                    .get(
                        `${APP_URL}/api/category/${categorySlug}/products?page=` +
                        this.page,
                        {
                            params: {
        ...
        getSubCategories(categorySlug) {
            axios
                .get(`${APP_URL}/api/category/${categorySlug}/sub-categories`)
                .then((res) => {
        ...
        showProductFilterButton() {
            this.$root.$emit('showProductFilterButton', true);
        }
    },
    computed: {
        totalProducts() {
