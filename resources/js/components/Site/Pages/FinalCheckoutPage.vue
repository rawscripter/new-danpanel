              ...
              <div class="checkout-customer-info">
                <div class="card border-0 shadow">
                  <div class="card-body">
                    ...
                    <form
                      action="#"
                      id="checkoutInforForm"
                      @submit.prevent="saveShippingMethod"
                    >
                      ...
                      <div class="form-group">
                        ...
                        <input
                          v-model="shippingInfo.company_name"
                          type="text"
                          class="form-control form-control-sm rounded-0"
                          name="company_name"
                        />
                      ...
                      <!-- <div class="form-group">
                                                <label>CVR</label>
                                                <input
                                                    v-model="shippingInfo.cvr_number"
                                                    type=""
                                                    class="form-control form-control-sm rounded-0"
                                                    name="cvr_number"/>
                                            </div> -->
                      <!-- <div class="form-group">
                                                <label>EAN</label>
                                                <input
                                                    v-model="shippingInfo.ean_number"
                                                    type="text"
                                                    class="form-control form-control-sm rounded-0"
                                                    name="ean_number"
                                                />
                ...
                <div class="cards shadow">
                  ...
                  <div class="card-body">
                    ...
                    >
                      ...
                      <p>
                        <input type="checkbox" required name="terms" /> Jeg har
                        læst og accepterer handelsbetingelserne
                        <router-link to="/handelsbetingelser" style=""
                          >Læs her.</router-link
                        >
                      </p>
                      <tr>
...
export default {
  ...
  methods: {
    ...
    initCheckout(paymentID) {
      var checkoutOptions = {
        checkoutKey: "a21c17c8-e530-40a0-9aef-ccbd6e95eb41", // for live [Required] Test or Live GUID with dashes
      ...
      checkout.on("payment-completed", function (response) {
        window.location =
          "/checkout/payment/status?paymentId=" + response.paymentId;
      });
    },
  },
  computed: {
    ...
    enablePaymentArea() {
      if (
        this.shipping_method === "hjemmelevering" ||
        this.shipping_method === "hent_selv"
      ) {
        return true;
      }
