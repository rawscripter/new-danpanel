            ...
            <div v-if="!isLoading">
                ...
                <div class="checkout-billing-area mt-4" v-if="!isLoading">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-lg-4" id="delivery_method_area"
                                        ...
                                        <div class="delivery-methods">
                                            <div v-for="(method,index) in shippingMethods" class="method bordered p-3"
                                                ...
                                                <div class="method-title">
                                                    ...
                                                    <small> <span
                                                        class="text-muted">{{ method.CityName }}</span></small>
                                                </div>
...
export default {
    ...
    methods: {
        saveShippingMethod() {
            ...
            // axios.post(`${APP_URL}/api/order/shipping/save`, this.shippingInfo)
            //     .then(response => {
            //     })
            //     .catch(error => {
