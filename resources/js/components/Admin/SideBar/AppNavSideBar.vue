<template>
  <div
    class="
      kt-aside kt-aside--fixed
      kt-grid__item
      kt-grid kt-grid--desktop kt-grid--hor-desktop
    "
    id="kt_aside"
  >
    <!-- begin:: Aside -->
    <div class="kt-aside__brand kt-grid__item" id="kt_aside_brand">
      <div class="kt-aside__brand-logo">
        <router-link to="/admin">
          <h2 class="text-white">Danpanel</h2>
        </router-link>
      </div>
    ...
    >
      ...
      >
        <ul class="kt-menu__nav">
          ...
          <li
            v-for="(menusItem, index) in menuItems"
            :key="index"
          ...
          >
            <a href="javascript:;" class="kt-menu__link kt-menu__toggle">
              ...
              <span class="kt-menu__link-text">{{ menusItem.title }}</span>
            ...
            <div class="kt-menu__submenu">
              ...
              <ul class="kt-menu__subnav">
                <li
                  v-for="(submenu, index) in menusItem.menus"
                  :key="index"
                  class="kt-menu__item kt-menu__item--submenu"
                  aria-haspopup="true"
                  data-ktmenu-submenu-toggle="hover"
                >
                  <router-link class="kt-menu__link" :to="submenu.link">
      ...
      menuItems: [
        ...
        },
        {
          ...
          menus: [
            ...
            {
              name: "Shop Products",
              link: "/admin/products?status=shop",
            },
            {
              name: "Package Products",
              link: "/admin/products?status=package",
            },
            {
              name: "Hent Tilbud Products",
              link: "/admin/products?status=hent-tilbud",
            },
