              ...
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <div class="text-center m-2">
                    <img
                      :src="`/blog/images/${formData.image}`"
...
export default {
  ...
  methods: {
    ...
    getBlog(product) {
      axios
        .get(`${APP_URL}/api/admin/blog/${product}`)
        .then((res) => {
          this.isLoading = false;
          this.formData = res.data.blog;
    ...
    saveFormData() {
      ...
      axios
        .put(
          `${APP_URL}/api/admin/blog/${this.formData.id}/update`,
          this.formData
        )
        .then((res) => {
          if (!res.data.errors) {
    ...
    createImage(file) {
      ...
      let vm = this;
      reader.onload = (e) => {
        vm.formData.blog_image = e.target.result;
      };
