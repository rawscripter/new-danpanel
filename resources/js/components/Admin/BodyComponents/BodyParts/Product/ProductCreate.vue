          ...
          <form @submit.prevent="saveFormData">
            <div class="form-group row">
              ...
              <div class="col-md-12">
                ...
                <ckeditor :editor="editor" v-model="formData.full_des" :config="editorConfig"></ckeditor>
              </div>

              <div class="col-md-12">
                <label class="col-form-label">Ordrenotat:</label>
                <ckeditor :editor="editor" v-model="formData.order_note" :config="editorConfig"></ckeditor>
              </div>
              ...
              <div class="col-md-4">
                ...
                <div class="form-check">
                  <input
                    ...
                    value="1"
                  />
                  <label class="form-check-label" for="is_offer_expirable">Set Product Expire Time</label>
                </div>
            ...
            <div class="form-group row mt-2">
              <div class="col-12">
                <input class="btn btn-block btn-primary" type="submit" value="Add New Product" />
              </div>
            </div>
          </form>
          <!--end: Datatable -->
