<template>
    <div class="row mt-5 pl-2 pr-2 m-0 no-margin">
                    ...
                    <form @submit.prevent="saveFormData">
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <select v-model="formData.sub_category_id" id="subCategories"
                                        class="form-control">
                                    <option>Select Category</option>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="form-check">
                                        <input v-model="formData.is_offer_expirable" class="form-check-input"
                                               type="checkbox"
                                               name="exampleRadios"
                                               id="is_offer_expirable" value="1">
                                    ...
                                    <div class="" v-if="formData.is_offer_expirable">
                                        <label for="expire_date" class="col-form-label">Expire
                                            Date:</label>
                                        <input required v-model="formData.expire_date" class="form-control"
                                               id="expire_date"
                                               type="datetime-local">
                                    </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group d-flex">
                                    <div class="form-check mr-5">
                                        <input v-model="formData.product_channel" class="form-check-input" type="radio"
                                               name="exampleRadios"
                                               id="exampleRadios1" value="private">
                                    ...
                                    <div class="form-check">
                                        <input v-model="formData.product_channel" class="form-check-input" type="radio"
                                               name="exampleRadios"
                                               id="exampleRadios2" value="business" checked>
        ...
        <div class="modal fade show" id="kt_select_modals" role="dialog" aria-modal="true"
             style="padding-right: 17px;" :class="showProductVariationOptionModal?'active':''">
            <div class="modal-dialog" style="margin-top: 150px" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Product Variation</h5>
                        <button @click="showProductVariationOptionModal = !showProductVariationOptionModal" type="button"
                                class="close" data-dismiss="modal" aria-label="Close">
                            <i aria-hidden="true" class="ki ki-close"></i>
                        </button>
                    </div>
...
<!--        <div class="modal fade show active" id="kt_opion_modal" role="dialog" aria-modal="true"-->
<!--             style="padding-right: 17px;" :class="showProductVariationOptionModal?'active':''">-->
<!--            <div class="modal-dialog " style="margin-top: 150px" role="document">-->
<!--                <div class="modal-content">-->
<!--                    <div class="modal-header">-->
