			...
			<span class="kt-portlet__head-icon">
                ...
                <div class="kt-portlet__body">
                    ...
                    <form @submit.prevent="saveFormData">
                        ...
                        <div class="form-group row">
                            <label for="category_Id" class="col-12 col-form-label">Select Category Channel:</label>
                            <div class="col-12">
                                <div class="form-group d-flex">
                                    <div class="form-check mr-5">
                                        <input v-model="formData.channel" class="form-check-input" type="radio"
                                               name="exampleRadios"
...
export default {
    ...
    data() {
        return {
            ...
            columns: ['id', 'name', 'icon','channel' ,'categoryName', 'priority', 'user', 'created_at', 'actions'],
            options: {
                headings: {
                    id: 'ID',
                    name: 'Name',
